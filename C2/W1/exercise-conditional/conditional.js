...
// Add another "else if", and this time check if the value of the age is under 18. Inside the "else if" block, "type console.log" and
//  then "You get an allowance".
...
// Make sure to use string values for days. Inside each case, for now, just add a console.log('Do something'), and add a break;
//  on the line below.
...
switch(day){
    case 'Monday':
        console.log('Do something on %s', day)
        break
    case 'Sunday':
        console.log('Do something on %s', day)
        break
