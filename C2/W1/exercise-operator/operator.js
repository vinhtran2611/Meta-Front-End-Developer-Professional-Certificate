...
// Use console.log() that includes the string "Mid-level skills:" and 
...
var result1 = test1 == 0
var result2 = test2 == 0
console.log("Is %s an even number? %s", num1, result1)
console.log("Is %s an even number? %s", num2, result2)
